...
def mock_requests_get(mocker):
    ...
    #the long string of dotted notation is the object returned from an api call
...
#call_args allows you to check what was passed to the function - in this case the first parameter is the url fetched ([0]), which will include wikipedia
